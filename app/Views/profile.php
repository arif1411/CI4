...
<body>
    <main id="main" class="main">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2 input-group">
                                ...
                                <div class="input-group-append ms-auto">
                                    <button class="btn btn-primary btn-sm rounded" onclick="window.location.href='<?php echo base_url('profilepermission'); ?>'">
                            ...
                            <table class=" table table-striped table-bordered">
                                <tr>
                                    <th style="width: 200px;background-color: #0D6EFD; color:white">Profile Name</th>
                                    <th style="width: 200px;background-color: #0D6EFD; color:white">Use</th>
                                    <th style="width: 400px;background-color: #0D6EFD; color:white">User</th>
        ...
        <tr>
            ...
            <td><?= $profile->user_login_names; ?></td>
        </tr>
    <?php endforeach; ?>
                            </table>
                        </div>
        ...
        $(document).ready(function () {
            ...
            function filterTable() {
                ...
                for (i = 0; i < tr.length; i++) {
                    ...
                    // Check against multiple columns 
