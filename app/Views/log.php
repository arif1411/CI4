        ...
        <section class="section">
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Audit Trail /Log</h5>
                            <div class="mb-2 input-group">
                                ...
                                <div class="input-group-append ms-auto">
                                    <button class="btn btn-primary btn-sm rounded" onclick="window.location.href='<?php echo base_url('addnewlot'); ?>'">
                            ...
                            <table class=" table table-striped table-bordered">
                                <tr>
                                    <th style="width: 200px;background-color: #0D6EFD; color:white"></th>
                                    <th style="width: 200px;background-color: #0D6EFD; color:white"></th>
                                    <th style="width: 200px;background-color: #0D6EFD; color:white"></th>
