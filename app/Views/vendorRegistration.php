    ...
    <div class="col-lg-10">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="<?= site_url('add-vendor') ?>" method="post">
            <div class="row mb-3">
              <label for="inputCompany" class="col-sm-2 col-form-label">Company Name</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name= "inputCompany">
              </div>
            </div>
            ...
            <div class="row mb-3">
              ...
              <input type="text" class="form-control" name="inputprefix" >
            ...
            <div class="row mb-3">
              ...
              <input type="number" class="form-control" name=inputContact>
...
<div class="row mb-3">
    ...
    <div class="col-sm-10">
        <textarea id="inputAddress" class="form-control" rows="4"  name= "inputAddress"></textarea>
    </div>
